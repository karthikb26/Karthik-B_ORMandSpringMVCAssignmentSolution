...
<div class="container">
    ...
    <hr>
        <a href="/cmsapp/customers/showFormForAdd"
        ...
        <c:forEach items="${customers}" var="tempCustomer">
            <tr>
                ...
                <td>
                    ...
                    <a href="/cmsapp/customers/showFormForUpdate?customerId=${tempCustomer.id}"
                       class="btn btn-info btn-sm"> Update </a>

                    <!-- Add "delete" button/link -->
                    <a href="/cmsapp/customers/delete?customerId=${tempCustomer.id}"
